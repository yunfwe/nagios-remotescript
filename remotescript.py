...
class ParseOptions(object):
    ...
    def usage():
        __doc__ = ('remotescript Version: {ver}\n'
                   ...
                   '    -s, --src=<src-path>            File source path. [vaild in put and get action]\n'
                   '    -d, --dest=<dest-path>          File destination path. [vaild in put and get action]\n'
                   ...
                   '    --sep=<sep>                     If use --append option, Use sep for arguments. [default=" "]\n'
